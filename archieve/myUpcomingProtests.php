...
<html>
    <head>
        ...
        <title>myUpcomingProtests</title>
    </head>
                ...
                <div class="dropdown">
                    <div id="myDropdown" class="dropdown-content">
                        <?php
                            ...
                            echo '<a href="myUpcomingprotests.php?user_id='.$row[0].'">My Upcoming protests</a>';
                            echo '<a href="createProtest.php?user_id='.$row[0].'">My Upcoming protests</a>';
                            echo '<a href="searchProtest.php?user_id='.$row[0].'">My Upcoming protests</a>';
                        ?>
